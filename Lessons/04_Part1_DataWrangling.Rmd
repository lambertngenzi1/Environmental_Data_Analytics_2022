...
```{r}
class(NTL.phys.data$lakeid)  #character is with Quote""
...
NTL.phys.data.year1999

# Exercise: 
# filter NTL.phys.data for Tuesday Lake from 1990 through 1999.

NTL.phys.data.TLake <- filter(NTL.phys.data, lakename ==
                        "Tuesday Lake") 
NTL.phys.data.TLake

NTL.phys.data.TLake.1990.1999 <- filter(NTL.phys.data, year4 %in%
                                          c(1990:1999))
NTL.phys.data.Tlake.1990.1999
