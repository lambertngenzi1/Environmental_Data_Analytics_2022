...
#Exercise 2:
#1
Ozone_plot <- ggplot(EPAair, aes(x = Ozone, fill = as.factor(Year))) +
...
print(Ozone_Boxplot)
# Everything in stat_summary is for the label
...
Pm2.5_lm <- lm(EPAair$PM2.5 ~ EPAair$Ozone)
summary(Pm2.5_lm)

#Exercise 4: Build a scatterplot. Add a line and standard error for the linear regression. 

PM2.5_Ozone_Plot <- ggplot(EPAair, aes(PM2.5, Ozone)) +
  geom_point() +
  geom_smooth(method = lm)
print(PM2.5_Ozone_Plot) +
  xlim(0, 100)
...
EPAair <- lm(data = Epair, PM2.5 ~ Ozone 
