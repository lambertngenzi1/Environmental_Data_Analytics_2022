...
ggplot(USGS.flow.data) +
  geom_histogram(aes(x = discharge.max))
...
#
ggplot(USGS.flow.data) +
  geom_histogram(aes(x = discharge.mean), bin = 20)
...
```{r, fig.height = 3, fig.width = 4}
# Only focusing one type of data
ggplot(USGS.flow.data) +
  geom_boxplot(aes(x = gage.height.mean.approval, y = gage.height.mean))

# looking at count and of numerical and categorical data
ggplot(USGS.flow.data) +
